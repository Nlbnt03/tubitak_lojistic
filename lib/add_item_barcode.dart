...
class AddItemBarcode extends StatefulWidget {
  final String barcode; // Barkod numarası

  const AddItemBarcode({Key? key, required this.barcode}) : super(key: key);

  @override
  State<AddItemBarcode> createState() => _AddItemBarcodeState();
}

class _AddItemBarcodeState extends State<AddItemBarcode> {
  ...
  void initState() {
    super.initState();
    barcodeController.text = widget.barcode; // Barkod verisini otomatik doldur
  }
